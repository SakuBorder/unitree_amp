...
import math
from phc.smpl_sim.utils.pytorch3d_transforms import axis_angle_to_matrix
from torch.autograd import Variable
from phc.smpl_sim.smpllib.smpl_joint_names import SMPL_MUJOCO_NAMES, SMPL_BONE_ORDER_NAMES, SMPLH_BONE_ORDER_NAMES, SMPLH_MUJOCO_NAMES
...
def main(cfg : DictConfig) -> None:
    ...
    # for i in robot_joint_names_augment:
    #     print(i)
    ...
    # for _, i in enumerate(cfg.robot.joint_matches):
    #     print(i[0], '----', i[1])
