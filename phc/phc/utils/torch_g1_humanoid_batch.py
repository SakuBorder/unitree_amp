import torch 
import numpy as np
import phc.phc.utils.rotation_conversions as tRot
import xml.etree.ElementTree as ETree
from easydict import EasyDict
import scipy.ndimage.filters as filters
import phc.smpl_sim.poselib.core.rotation3d as pRot
...
class Humanoid_Batch:
    ...
    def __init__(self, mjcf_file = f"/home/dy/dy/code/PHC/phc/data/assets/robot/unitree_g1/g1_29dof.xml", extend_hand = True, extend_head = False, device = torch.device("cpu")):
